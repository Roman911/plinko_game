...
import PlinkoEngine2 from '$lib/components/Plinko/PlinkoEngine2';
...
export const plinkoEngine2 = writable<PlinkoEngine2 | null>(null);

export const betAmount = writable<number>(1);

export const betAmountOfExistingBalls = writable<BetAmountOfExistingBalls>({});

export const rowCount = writable<RowCount>(4);
export const rowCount2 = writable<RowCount>(6);

export const riskLevel = writable<RiskLevel>(RiskLevel.MEDIUM);
export const riskLevel2 = writable<RiskLevel>(RiskLevel.HIGH);

export const winRecords = writable<WinRecord[]>([]);
export const winRecords2 = writable<WinRecord[]>([]);
