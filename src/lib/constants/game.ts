 ...
 */
export const rowCountOptions = [4, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16] as const;
...
export const binColorsByRowCount2 = rowCountOptions.reduce(
  (acc, rowCount) => {
    acc[rowCount] = getBinColors(10);
    return acc;
  },
  {} as Record<RowCount, ReturnType<typeof getBinColors>>,
);
